      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="text-center max-w-md">
          ...
          <button 
            ...
            className="px-4 py-2 bg-gradient-to-r from-[#00ff88] to-[#00d4ff] text-black rounded-lg"
          >
            Go to Practice Mode
          </button>
        </div>
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          <button
            onClick={onBack}
            className="inline-flex items-center gap-2 text-[#a0a0a0] hover:text-white mb-4"
          >
          ...
          <p className="text-[#a0a0a0]">{certification.provider}</p>
        </div>
        ...
        {examConfig && (
          <div className="bg-white/5 border border-white/10 rounded-xl p-4 mb-6">
            ...
            <div className="grid grid-cols-3 gap-4 text-sm">
              <div>
                <div className="text-[#a0a0a0]">Questions</div>
                <div className="font-semibold">{examConfig.totalQuestions}</div>
              </div>
              <div>
                <div className="text-[#a0a0a0]">Time Limit</div>
                <div className="font-semibold">{examConfig.timeLimit} min</div>
              </div>
              <div>
                <div className="text-[#a0a0a0]">Passing</div>
        ...
        <div className="space-y-3 mb-6">
          ...
          <button
            ...
            className={`w-full p-4 rounded-xl border-2 text-left transition-all ${
              examMode === 'practice' 
                ? 'border-[#00ff88] bg-gradient-to-r from-[#00ff88]/5 to-[#00d4ff]/5' 
                : 'border-white/10 hover:border-[#00ff88]/50'
            }`}
          >
            <div className="flex items-center gap-3">
              <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                examMode === 'practice' ? 'bg-gradient-to-r from-[#00ff88] to-[#00d4ff] text-white' : 'bg-white/10'
              }`}>
                <Lightbulb className="w-5 h-5" />
              </div>
              <div>
                <div className="font-medium">Learning Mode</div>
                <div className="text-sm text-[#a0a0a0]">See explanations after each answer</div>
              </div>
            </div>
          </button>
          ...
          >
            <div className="flex items-center gap-3">
              <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                examMode === 'timed' ? 'bg-gradient-to-r from-[#00ff88] to-[#00d4ff] text-white' : 'bg-white/10'
              }`}>
                <Clock className="w-5 h-5" />
              </div>
              <div>
                <div className="font-medium">Exam Simulation</div>
                <div className="text-sm text-[#a0a0a0]">Timed test, results at the end</div>
              </div>
            </div>
          </button>
        </div>
              ...
              <button
                ...
                className={`flex-1 py-2 rounded-lg font-medium transition-all ${
                  questionCount === count
                    ...
                    : 'bg-white/10 hover:bg-white/10/80'
                }`}
              >
                {count}
              </button>
        ...
        <button
          onClick={onStart}
          className="w-full py-4 bg-gradient-to-r from-primary to-primary/80 text-black rounded-xl font-semibold flex items-center justify-center gap-2 hover:opacity-90 transition-opacity"
        >
    ...
    <div className="min-h-screen flex flex-col">
        ...
        <div className="max-w-4xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              >
                <Home className="w-4 h-4 text-[#a0a0a0]" />
              </button>
          ...
          <div className="mt-2 h-1 bg-white/10 rounded-full overflow-hidden">
            <div 
              className="h-full bg-gradient-to-r from-[#00ff88] to-[#00d4ff] transition-all"
        ...
        {showNav && (
          ...
          >
            <motion.div
              ...
              animate={{ y: 0 }}
              exit={{ y: '100%' }}
              className="absolute bottom-0 left-0 right-0 bg-white/5 rounded-t-2xl p-4 max-h-[60vh] overflow-y-auto"
            ...
            >
              ...
              <div className="mt-4 flex gap-4 text-xs text-[#a0a0a0] justify-center">
                ...
                <span className="flex items-center gap-1">
                  <div className="w-3 h-3 rounded bg-white/10" /> Unanswered
                </span>
              </div>
            </motion.div>
          </motion.div>
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-6">
        ...
        <div className="flex items-center gap-2 mb-4">
          <span className="px-2 py-1 bg-gradient-to-r from-[#00ff88]/10 to-[#00d4ff]/10 text-[#00ff88] text-xs rounded-full font-medium">
          ...
          <button
            ...
            className={`ml-auto p-1.5 rounded-lg transition-colors ${
              isFlagged ? 'bg-amber-500/10 text-amber-500' : 'hover:bg-white/10 text-[#a0a0a0]'
            }`}
          >
              ...
              >
                <div className="flex items-start gap-3">
                  <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center flex-shrink-0 mt-0.5 ${
                    ...
                    isSelected ? 'border-[#00ff88] bg-gradient-to-r from-[#00ff88] to-[#00d4ff]' :
      ...
      <footer className="sticky bottom-0 bg-black/95 backdrop-blur-xl border-t border-white/10 p-4 shadow-lg shadow-[#00ff88]/5">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          {currentIndex === totalQuestions - 1 ? (
            <button
              onClick={onFinish}
              className="flex items-center gap-2 px-6 py-2 bg-gradient-to-r from-[#00ff88] to-[#00d4ff] text-black rounded-lg font-medium"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#00ff88] to-[#00d4ff] text-black rounded-lg disabled:opacity-50"
            >
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-center">
            <Target className="w-5 h-5 mx-auto mb-2 text-[#00ff88]" />
            <div className="text-2xl font-bold">{results.correct}</div>
            <div className="text-xs text-[#a0a0a0]">Correct</div>
          </div>
          <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-center">
            <Trophy className="w-5 h-5 mx-auto mb-2 text-[#00ff88]" />
            <div className="text-2xl font-bold">{results.avgTime}s</div>
            <div className="text-xs text-[#a0a0a0]">Avg Time</div>
          </div>
          <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-center">
            <BarChart3 className="w-5 h-5 mx-auto mb-2 text-[#00ff88]" />
            <div className="text-2xl font-bold">{examConfig?.passingScore || 70}%</div>
            <div className="text-xs text-[#a0a0a0]">Pass Mark</div>
          </div>
        </div>
                ...
                return (
                  <div key={domain.id}>
                    <div className="flex justify-between text-sm mb-1">
                      <span className="text-[#a0a0a0]">{domain.name}</span>
        ...
        <div className="space-y-3">
          <button
            onClick={onReview}
            className="w-full py-3 bg-gradient-to-r from-[#00ff88] to-[#00d4ff] text-black rounded-xl font-medium flex items-center justify-center gap-2"
          >
          ...
          <button
            onClick={onBack}
            className="w-full py-3 text-[#a0a0a0] hover:text-white transition-colors"
          >
            Back to Certification
          </button>
        </div>
